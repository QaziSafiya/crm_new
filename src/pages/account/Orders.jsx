...
export default function Orders() {
  ...
  const fetchOrders = useCallback(async () => {
    const res = await fetch(`${BASE_URL}/orders?pageNo=${page}`, {
      headers: new Headers({
  ...
  const {
    ...
    isLoading,
    error: fetchError,
  } = useQuery(["orders", page], fetchOrders);
//   console.log(data);
  return (
            ...
            <>
              {!data && !data.data ? (
                <div className="section ai-center jc-center">
                  ...
                  <a
                    href="https://itaxeasy.com/register-startup"
                    target="_blank"
                    className="button is-primary is-small text-large"
                  >
                    Browse Services
                  </a>
                </div>
