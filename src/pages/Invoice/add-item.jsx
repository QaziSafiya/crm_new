  ...
  return (
    <div className="container">
      ...
      <div className="main">
        ...
        { !showForm && (<h6 className="text-secondary font-bold">Add New Item</h6>)}
...
{showForm && (
            <>
            <h1 className="text-secondary font-bold">Add Items</h1>
          <form onSubmit={handleSubmit} className="w-full">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <input
                  className="w-full border border-gray-400 px-3 py-2 rounded-lg w-5"
                  id="taxExempted"
                  name="taxExempted"
                  type="checkbox"
