    ...
    <div className="container">
      ...
      <div className="main">
        ...
        <div className="inner-container">
          ...
          {/* <div className="flex div jc-between ai-center flex-wrap g-1rem">
            <div className="flex dir-col g-1rem">
                            <Link to="/gst/outward-supplies" className="   is-primary is-small has-icon">
                                <ArrowLeftIcon />
          ...
          <div className="flex g-1rem g-0_25rem-mobile">
            <div className="small-container drawer-relative p-0">
              <div data-open={`${isOpen ? true:false}`} className="flex p dir-col g-1rem mini-container">
                <div className="flex dir-col g-1rem">
                  {showhide === "Howdy" ? (
              ...
              <div className="w-100pc">
                  ...
                  >
                    ...
                    </option>
                    {
                      ...
                      type === "regular" ? (
                        ...
                        <option
                          value={currentQuarter[currentQuarter.length - 1].i}
                        >
                ...
                <div className="scrollable">
                  <table className="flex-wrap">
                    <thead>
                      <tr>
                        <th className="py-1 p-0_25-mobile">Supply Value</th>
