...
import OTPPage from "./login-page";
// import OTPPage from "./login-page";
...
const Gstr = () => {
  ...
  const isValidGstin = (input) => {
    ...
    const gstinPattern =
      /^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Za-z]{1}[Z]{1}[0-9A-Z]{1}$/;
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      const result = await gstRequest.json();
      console.log("afterLogin", result);
  ...
  const getValidMonths = () => {
    ...
    if (selectedYear === currentYear) {
      // If the selected year is the current financial year
      return months.filter(
        (month) =>
          validMonths.includes(month.value) && month.value <= currentMonth
      );
    } else {
      ...
      <div className="main">
        ...
        <div className="inner-container">
          ...
          <div className="flex border-2 gap-2">
            <div className="custom-button">Check Return Status</div>
            <div className="custom-button" onClick={habdleDetail}>
              Permanent Information
            </div>

            <div className="custom-button">Registration Details</div>
            <div className="">
              {showhide === "Howdy" ? (
                <button className="button is-primary is-small">Howdy!</button>
              ) : (
                <div>
                  <div className="custom-button" onClick={openModal}>
                    Login
                  </div>
                </div>
              )}
          ...
          <div className="flex">
            <div className="border-2 w-1/4 pt-10 ">
              <Link to="/gst/outward-supplies">
                <div className="flex justify-between pr-1 pl-1 mt-2">
                  <div className="custom-button2">Outward Supplies</div>
              ...
              <Link to="/gst/inward-supplies">
                <div className="flex justify-between pr-1 pl-1 mt-1">
                  <div className="custom-button2">Inward Supplies</div>
                ...
                <tbody>
                  {tableData.map((row, index) => (
                    <tr key={index} className="h-10">
                      ...
                      <td className="border  p-2 text-sm text-gray-900">
                        {row.igst}
                      </td>
                      <td className="border  p-2 text-sm text-gray-900">
                        {row.cgst}
            ...
            <div className="border-2 w-1/4 pt-0">
              ...
              <div className="flex justify-between pt-2 pb-2 pl-1 pr-1 mr-1 text-sm">
                <h1 className="custom-button1">Ledger details</h1>
                <h1>Balance</h1>
              </div>
              <div className="flex justify-between pt-2 pb-2 pl-1 pr-1 mr-1 text-sm">
                <h1>Credit Ledger</h1>
              ...
              <div className="flex justify-between pt-2 pb-2 pl-1 pr-1 mr-1 text-sm">
                <h1 className="custom-button1">PMT09</h1>
                <h1>0</h1>
              </div>
              <div className="flex justify-between pt-2 pb-2 pl-1 pr-1 mr-1 text-sm">
                <h1 className="custom-button1">Late Fees +</h1>
                <h1>0</h1>
              </div>
              <hr></hr>
              <hr></hr>
              <div className="flex text-sm justify-between items-center mt-2 pr-1 pl-1">
                <div className="custom-button1">Annual Return GSTR-9</div>
                <div className="custom-button1">GSTR-9C</div>
              </div>
            </div>
          </div>
          </div>
